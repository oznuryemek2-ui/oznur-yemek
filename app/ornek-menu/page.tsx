...
export default function Menu(){return <main><PageHero eyebrow="ÖRNEK MENÜ" title="Dengeli, lezzetli ve besleyici." text="Menüler proje ihtiyaçlarına, mevsime ve kişi profiline göre aylık olarak planlanır." image="/images/site/menu-food.webp"/>
