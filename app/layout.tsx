...
export const metadata:Metadata={
  ...
  description:"Öznur Yemek; yerinde üretim, taşımalı yemek, paket yemek ve organizasyon hizmetlerinde güçlü üretim altyapısı, hijyenik süreçler ve planlı operasyon sunar.",
